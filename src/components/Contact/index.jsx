  ...
  return (
    <div className="flex flex-col items-center mt-10 mb-5">
      ...
      <div className="flex flex-col items-center my-5 px-5 text-center">
        <h2 className="font-bold mb-5 text-lg md:text-xl lg:text-2xl xl:text-3xl">Institut address</h2>
        <p className="mb-10 text-md md:text-lg lg:text-xl xl:text-2xl">Farg'ona viloyati Qo'qon shaxri Turon ko'chasi 17-uy</p>
