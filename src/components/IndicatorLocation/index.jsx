        ...
        <div className="w-full flex flex-col justify-center items-center gap-y-10 bg-gray-50">
            ...
            <div className="w-[80%] my-14">
                ...
                <div className="w-full flex justify-between text-xs mt-4">
                    <h1 className="text-[18px] "><TranslateMessage id="homJarayonKorsatkichContent_1" /></h1>
                    <h1 className="text-[18px] "><TranslateMessage id="homJarayonKorsatkichContent_2" /></h1>
                    <h1 className="text-[18px] "><TranslateMessage id="homJarayonKorsatkichContent_3" /></h1>
                    <h1 className="text-[18px] "><TranslateMessage id="homJarayonKorsatkichContent_4" /></h1>
                </div>
            </div>
        </div>
    );
