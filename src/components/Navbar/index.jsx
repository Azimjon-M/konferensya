      ...
      <div className="navbar bg-base-100 shadow-lg py-3 px-5">
        ...
        <div className="navbar-start">
          ...
          <Link to="/" className="text-xl flex items-center gap-3">
            <img className="w-[45px] h-auto" src={icon} alt="icon" />
            <p
              className={`${
            ...
            <div>
              ...
              >
                <div className="w-[20px] h-[20px] overflow-hidden rounded-full">
                  <img className="w-full h-full" src={data[Lang]} alt="icon" />
                </div>
                <TranslateMessage id="navTil" />
                <FaAngleRight
                  className={`${
                    togglerMenu ? "rotate-[270deg]" : "rotate-[90deg]"
            ...
            >
              ...
              >
                <li className="flex items-center gap-x-2">
                  <div className="w-[20px] h-[20px] overflow-hidden rounded-full">
                    <img className="w-full h-full" src={uzIcon} alt="icon" />
                  </div>
              ...
              >
                <li className="flex items-center gap-x-2">
                  <div className="w-[20px] h-[20px] overflow-hidden rounded-full">
                    <img className="w-full h-full" src={ruIcon} alt="icon" />
                  </div>
              ...
              >
                <li className="flex items-center gap-x-2">
                  <div className="w-[20px] h-[20px] overflow-hidden rounded-full">
                    <img className="w-full h-full" src={enIcon} alt="icon" />
                  </div>
